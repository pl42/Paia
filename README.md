# paia [![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](https://opensource.org/licenses/MIT) [![Build Status](https://travis-ci.com/PL42/paia.svg?branch=master)](https://travis-ci.com/PL42/paia) [![Coverage](https://sonarcloud.io/api/project_badges/measure?project=PL42_paia&metric=coverage)](https://sonarcloud.io/dashboard?id=PL42_paia)
